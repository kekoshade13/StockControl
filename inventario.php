            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <div class="card d-none" id="pageFiltros">
                        ...
                        <div class="row">
                            <button class="btn btn-outline-primary col-6 btnFiltrar" style="margin-right: 15px; margin-left: 22px;">Filtrar</button>
                            <button class="btn btn-outline-danger col-4 btnLimpiar">Limpiar</button>
                        </div>
