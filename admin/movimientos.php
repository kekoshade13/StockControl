...
if($connectAdmin->class != "Admin") {
    echo '<script>alert("No tienes permisos para realizar esta acción.");</script>';
        ...
        <div class="col-2" style="padding-left: 0;">
            ...
            <div class="col-10">  
                ...
                <div class="col-4">
                    ...
                    <button type="button" class="btn btn-outline-success mb-3 btnDownloadTable"><svg xmlns="http:/www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filter"viewBox="0 0 16 16">
                    <path d="M6 10.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 01h-11a.5.5 0 0 1-.5-.5z"/>
                    </svg>Descargar Tabla</button>
...
<script>
    ...
    $(document).on('click', '.btnDownloadTable', function(e) {
            var fechaIni1 = document.getElementById('startDate').value;
            var fechaFin1 = document.getElementById('endDate').value;
            var codigo1 = document.getElementById('codigoRep').value;
            var tipoMov1 = document.getElementById('tipoMov').value;
            var tipoStock1 = document.getElementById('tipoStock').value;
            var usuario1 = document.getElementById('selectUsuario').value;
            $.ajax({
                url: '../assets/php/inventoryClass.php',
                data: {dateIni: fechaIni1, dateFin: fechaFin1, code: codigo1, nombre_u: usuario1, tipoMovi: tipoMov1, tipoStoc: tipoStock1, tableD: downloadTable, funcion: "filtrarMovimientosGenerales"},
                type: "post",
                success: function(event) {
                    $('#tabla-movimientos').html(event);
                },
