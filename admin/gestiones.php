        ...
        <div class="col-10">
            ...
            <div class="listaTareas col-8">
                ...
                <div class="dropdown btn-group d-none col-6" id="admGest1" style="position:relative; top: 5px; left: 50px;">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <li><button class="btn dropdown-item btn-lg" id="addNewRepuest" type="button" onclick="admGestiones('gestRepu', 'addNewEquipo')">Añadir Equipos</button></li>
            ...
            <div class="w-100 font-weight-bold" style="height: 70%; justify-content: center; align-items: center; font-size: 23px;">
                ...
                <div class="col-8 m-2 mt-5 d-none" id="addNewEquipo" style="display: inline-block;">
                    <form>
                        <div class="form-group row">
                            <h5 class="display-5 mb-5">Añadir Nuevo Equipo</h1>
                        ...
                        <input type="button" class="btn btn-success w-100 mb-2 btnAddNewEquipo" value="Añadir Nuevo Equipo" />
                    </form>
                </div>
                </center>
    ...
    <script>
        ...
        function admGestionRepuestos(admGestR) {
            if(admGestR == 'addStock') {
                ...
                document.getElementById('resultadoGestionR').innerHTML = "Añadir Equipos";
                    ...
                    if(txtEquipo.trim() != "") {
                        $.ajax({
                            ...
                            success: function(e) {
                                ...
                                if(messEq == 1) {
                                    toastr.success("Se añadió el equipo correctamente.");
                                } else if(messEq == 0) {
